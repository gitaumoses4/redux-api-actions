...
function createReducer(initialState, actionType) {
  ...
  return function (state, action) {
    ...
    if (action != null && action.id) {
      ...
      return updatedState ? _objectSpread(_objectSpread({}, state), {}, {
        instances: _objectSpread(_objectSpread({}, instances), {}, (_objectSpread2 = {}, _objectSpread2[id] = updatedState, _objectSpread2))
      }) : state;
    }
...
function generateActions(api, name) {
  ...
  groupNames.forEach(function (groupName) {
    ...
    apiActions[groupName] = Object.keys(group).reduce(function (acc, endpointName) {
      ...
      return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread2 = {}, _objectSpread2[endpointName] = function () {
...
function generateApiActionsGroup(apiGroup, prefix) {
  ...
  return endpointNames.reduce(function (acc, endpointName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread3 = {}, _objectSpread3[endpointName] = {
...
function generateReducers(api, name) {
  ...
  return groupNames.reduce(function (acc, groupName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread4 = {}, _objectSpread4[groupName] = reducerBuilder(generateApiActionsGroup(api[groupName], name + "_" + groupName)), _objectSpread4));
  }, {});
}
/**
...
function generateActionsTypes(api, name) {
  ...
  return groupNames.reduce(function (acc, groupName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread5 = {}, _objectSpread5[groupName] = generateActionTypesForGroup(api[groupName], name + '_' + groupName), _objectSpread5));
  }, {});
}
...
function generateActionTypesForGroup(apiGroup, prefix) {
  ...
  return endpointNames.reduce(function (acc, endpointName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread6 = {}, _objectSpread6[endpointName] = prefix + '_' + endpointName, _objectSpread6));
  }, {});
}
/**
...
function generateEndpoints(api) {
  ...
  return groupNames.reduce(function (acc, groupName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread7 = {}, _objectSpread7[groupName] = generateEndpointsForGroup(api[groupName], groupName), _objectSpread7));
  }, {});
}
...
function generateEndpointsForGroup(apiGroup, groupName) {
  ...
  return endpointNames.reduce(function (acc, endpointName) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, (_objectSpread8 = {}, _objectSpread8[endpointName] = [groupName, endpointName], _objectSpread8));
  }, {});
}
/**
...
function combineApiReducers(apiReducers) {
  ...
  return {
    ...
    reducer: combineReducers(combinedReducer)
  };
}
...
function useApiAction(api, getEndpoint, actionParams) {
  ...
  var _useState = useState(DEFAULT_ACTION_ID),
      id = _useState[0],
      setId = _useState[1];
...
function connectApi(Comp, api, mapActions) {
    return function (props) {
        return createElement(Comp, Object.assign({}, props, createApiActions(api, mapActions)));
    };
}
...
export { buildApiReducer, combineApiReducers, apiConnector as connectApi, handleApiError, useApiAction };
